  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-bg-elevated border border-border rounded-2xl p-5 sm:p-6 shadow-xs space-y-4">
        <div className="flex items-center gap-2 pb-2 border-b border-slate-100 dark:border-[#2A2018]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="space-y-1">
              ...
              <input
                ...
                required
                className="w-full px-3.5 py-2 bg-bg dark:bg-[#241C14]/60 border border-slate-200 dark:border-[#2A2018] rounded-xl text-xs text-slate-800 dark:text-[#F5F1EB] focus:outline-none focus:ring-2 focus:ring-pink-500/20 focus:border-pink-500"
              />
            </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-2">
            <label className="inline-flex items-center gap-2 cursor-pointer text-xs font-semibold text-slate-700 dark:text-[#A89E92]">
              <input
                type="checkbox"
                checked={isPublic}
                onChange={(e) => setIsPublic(e.target.checked)}
                className="w-4 h-4 rounded text-accent focus:ring-pink-500 border-slate-300 dark:border-[#2A2018]"
              />
      ...
      <div className="bg-bg-elevated border border-border rounded-2xl shadow-xs overflow-hidden">
        <div className="p-4 sm:p-5 border-b border-slate-100 dark:border-[#2A2018] flex items-center justify-between">
                ...
                {[...donations]
                  ...
                  .map((item) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4 max-w-xs text-slate-600 dark:text-[#A89E92] truncate">
                      ...
                      <td className="py-3 px-4 whitespace-nowrap">
                        {item.is_public ? (
                          ...
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-semibold bg-slate-100 text-slate-600 dark:bg-[#241C14] dark:text-[#A89E92] border border-slate-200 dark:border-[#2A2018]">
                      ...
                      <td className="py-3 px-4 text-right whitespace-nowrap">
                        <div className="flex items-center justify-end gap-1">
                          <button
                            ...
                            className="p-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-[#241C14] text-slate-400 hover:text-slate-700 dark:hover:text-[#F5F1EB] transition cursor-pointer"
                            title="Edit donation"
                          >
      ...
      {editingDonation && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-150">
          <div className="w-full max-w-md bg-bg-elevated rounded-2xl shadow-xl border border-border p-6 space-y-4">
            <div className="flex items-center justify-between pb-2 border-b border-slate-100 dark:border-[#2A2018]">
              ...
              <button
                ...
                className="text-slate-400 hover:text-slate-600 dark:hover:text-[#F5F1EB] text-sm font-bold cursor-pointer"
              >
                ✕
              </button>
            </div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 mt-1 bg-bg dark:bg-[#241C14]/60 border border-slate-200 dark:border-[#2A2018] rounded-xl text-xs text-slate-800 dark:text-[#F5F1EB] focus:outline-none focus:ring-2 focus:ring-pink-500/20 focus:border-pink-500"
                  required
                />
              </div>
              ...
              <div className="flex items-center gap-2 pt-1">
                <input
                  ...
                  className="w-4 h-4 rounded text-accent focus:ring-pink-500 border-slate-300 dark:border-[#2A2018] cursor-pointer"
                />
                <label htmlFor="edit-public" className="text-xs text-slate-700 dark:text-[#A89E92] cursor-pointer">
                  Show publicly on Home & Help pages
                </label>
              </div>
            </div>

            <div className="flex justify-end gap-2 pt-3 border-t border-slate-100 dark:border-[#2A2018]">
              <button
                type="button"
                onClick={() => setEditingDonation(null)}
                disabled={isPending}
                className="px-4 py-2 rounded-xl text-xs font-semibold text-slate-600 dark:text-[#A89E92] hover:bg-slate-100 dark:hover:bg-[#241C14] transition cursor-pointer"
              >
                Cancel
              </button>
              <button
