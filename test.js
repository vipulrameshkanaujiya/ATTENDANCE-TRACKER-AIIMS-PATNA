function generateFutureClasses(
  startDate,
  endDate,
  batch
) {
  ...
  const getOccurrenceOfWeekday = (d) => {
...
const classes = generateFutureClasses('2026-09-12', '2026-11-01', 'Batch B');
const pathPrac = classes.filter(c => c.subject_code === 'PATH' && c.class_type === 'Practical').length;
const pharmaPrac = classes.filter(c => c.subject_code === 'PHARMA' && c.class_type === 'Practical').length;
const microPrac = classes.filter(c => c.subject_code === 'MICRO' && c.class_type === 'Practical').length;
console.log('PATH Practicals: ' + pathPrac);
console.log('PHARMA Practicals: ' + pharmaPrac);
console.log('MICRO Practicals: ' + microPrac);
