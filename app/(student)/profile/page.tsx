    ...
    <div className="space-y-6 max-w-lg mx-auto">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-6">
        ...
        <div className="flex items-center gap-4 border-b border-slate-100 pb-5">
          <div className="w-16 h-16 rounded-full bg-blue-100 text-blue-700 flex items-center justify-center font-bold text-xl border-2 border-blue-200 flex-shrink-0">
            {profile?.avatar_url ? (
              <img
        ...
        <div className="pt-2 border-t border-slate-100">
          <form action={signOutAction}>
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl border border-rose-200 bg-rose-50/70 hover:bg-rose-100 text-rose-700 text-xs font-bold uppercase tracking-wider transition"
            >
